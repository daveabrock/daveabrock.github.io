...
description: "Use Blazor component virtualization to improve perceived performance of components that work with large data sets."
tags: [blazor, aspnet-core]
image: /assets/img/virtualization-card.png
---
