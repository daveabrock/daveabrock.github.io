...
tags: [dotnet-stacks]
comments: false
image: /assets/img/stacks-12-card.png
description: We discuss Microsoft CI/CD options, find out who's on the .NET Foundation board, and look at the busy week in the .NET community!
---
