...
description: "In this post, we explore how you can use route-to-code instead of controllers, and the benefits and drawbacks."
tags: [aspnet-core, apis]
image: /assets/img/route-to-code-card.png
---
